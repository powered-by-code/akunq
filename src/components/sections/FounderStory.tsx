        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div className="flex flex-col items-center">
            <div className="relative w-full">
              ...
              <div aria-hidden="true" className="glow-orb w-[200px] h-[200px] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 opacity-20 -z-10" style={{ background: 'rgba(59,130,246,0.3)' }} />
            </div>
